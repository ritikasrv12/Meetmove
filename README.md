...
**MeetMove: The Video conferencing web application has the services of peer connections, text chat, creating and scheduling meetings, ai based posture bot, and URL compressor. with adding a firebase-auth, 1-1 meeting option, and user feedback form.**
