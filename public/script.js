...
navigator.mediaDevices
  ...
  .then((stream) => {
    ...
    socket.on("createMessage", ({ message, user }) => {
      console.log(message);
      $("ul").append(
        `<li class="message" style="font-size: 15px" ><b><img width="40px" style="border-radius: 50%; padding: 5px;" src="${user.photoURL
...
myPeer.on("open", async (id) => {
  ...
  resp.messages.forEach((message) => {
    $("ul").append(
      `<li class="message" style="font-size: 15px" ><b><img width="40px" style="border-radius: 50%; padding: 5px;" src="${message.user.photoURL
